...
class MedecinController extends AbstractController
{
     ...
     */
    public function new(Request $request , MedecinRepository $repo, MatriculeGenerator $mat_generator): Response
    {
       ...
       dump($mat_generator);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            //recuperation et generation du maT
            $medecin->setMatricule($mat_generator->generate());
     ...
     */
    public function edit(Request $request, Medecin $medecin, MatriculeGenerator $mat_generator): Response
    {
        $form = $this->createForm(MedecinType::class, $medecin);
        $form->handleRequest($request);
